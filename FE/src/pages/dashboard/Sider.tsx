          ...
          <ul className="space-y-2 font-medium">
            <li>
              <NavLink
                ...
                className={({ isActive }) =>
                  isActive
                    ? "flex items-center p-2 text-slate-900 rounded-lg dark:text-white hover:bg-slate-100 dark:hover:bg-slate-700 group border-b-white border"
            ...
            <li>
              ...
              >
                ...
                <span className="flex-1 ms-3 whitespace-nowrap">Add Study</span>
            ...
            <li>
              ...
              >
                ...
                <span className="flex-1 ms-3 whitespace-nowrap">Top 5</span>
              </NavLink>
            </li>
            <li>
              <a
